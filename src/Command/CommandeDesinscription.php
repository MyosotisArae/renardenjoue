...
class CommandeDesinscription extends Command
{
    protected static $defaultName = 'app:desinscription';
    private $botId;
    private $client;
    ...
    public function execute(InputInterface $input, OutputInterface $output): int {
        ...
        $command = $this->client->createGlobalCommand(
            'desinscription',
            'Pour annuler votre participation à une séance de jeu.', // Cette commande doit être faite dans le channel de la séance, dans Parties.
            []
        );
