...
// Returns the private 'App\Repository\LudothequeRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/LudothequeRepository.php';

return $this->privates['App\\Repository\\LudothequeRepository'] = new \App\Repository\LudothequeRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
