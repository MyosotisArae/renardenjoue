...
class srcApp_KernelDevContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'App\\Controller\\CalendrierController' => 'getCalendrierControllerService.php',
            'App\\Controller\\ContactController' => 'getContactControllerService.php',
            'App\\Controller\\ExceptionController' => 'getExceptionControllerService.php',
            'App\\Controller\\JeuxController' => 'getJeuxControllerService.php',
            'App\\Controller\\ParentController' => 'getParentControllerService.php',
        ...
        $this->privates['service_container'] = function () {
            ...
            include_once \dirname(__DIR__, 4).'/src/Service/Utilitaires.php';
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $a->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'App\\Repository\\EvenementsRepository' => ['privates', 'App\\Repository\\EvenementsRepository', 'getEvenementsRepositoryService.php', true],
            'App\\Repository\\LudothequeRepository' => ['privates', 'App\\Repository\\LudothequeRepository', 'getLudothequeRepositoryService.php', true],
            'App\\Repository\\ParticipantRepository' => ['privates', 'App\\Repository\\ParticipantRepository', 'getParticipantRepositoryService.php', true],
            ...
            'App\\Repository\\LudothequeRepository' => '?',
    ...
    protected function getTwigService()
    {
        ...
        $c = ($this->services['request_stack'] ?? ($this->services['request_stack'] = new \Symfony\Component\HttpFoundation\RequestStack()));
        $d = new \SunCat\MobileDetectBundle\Twig\Extension\MobileDetectExtension(($this->privates['mobile_detect.mobile_detector.default'] ?? ($this->privates['mobile_detect.mobile_detector.default'] = new \SunCat\MobileDetectBundle\DeviceDetector\MobileDetector())), ($this->privates['mobile_detect.device_view'] ?? $this->getMobileDetect_DeviceViewService()), $this->parameters['mobile_detect.redirect']);
        $d->setRequestByRequestStack($c);
        ...
        $instance->addExtension(new \App\Twig\AppExtension(($this->privates['App\\Service\\Utilitaires'] ?? ($this->privates['App\\Service\\Utilitaires'] = new \App\Service\Utilitaires()))));
        ...
        $instance->addGlobal('img_path', '/images/');
        $instance->addGlobal('css_path', '/css/');
        $instance->addGlobal('js_path', '/js/');
        $instance->addGlobal('fc_path', '/node_modules/fullcalendar/');
        $instance->addGlobal('BScss_path', 'https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/css/bootstrap.min.css');
        $instance->addGlobal('BSjs_path', 'https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/js/bootstrap.min.js');
        $instance->addGlobal('jQuery', 'https://ajax.googleapis.com/ajax/libs/jquery/3.4.1/jquery.min.js');
        $instance->addGlobal('jQuery2', 'https://ajax.googleapis.com/ajax/libs/jquery/2.2.4/jquery.min.js');
        $instance->addGlobal('jQuery1', 'https://ajax.googleapis.com/ajax/libs/jquery/1.12.4/jquery.min.js');
    ...
    /*
     * Gets the private 'App\Service\Utilitaires' shared autowired service.
     *
     * @return \App\Service\Utilitaires
     */
    protected function getUtilitairesService()
    {
        return $this->privates['App\\Service\\Utilitaires'] = new \App\Service\Utilitaires();
    }
    ...
    {
        return $this->privates['cache.validator'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('S-xdamSgiC', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
