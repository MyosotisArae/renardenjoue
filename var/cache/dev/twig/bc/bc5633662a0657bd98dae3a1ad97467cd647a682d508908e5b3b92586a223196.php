...
class __TwigTemplate_e0c979b5067bfbfd8394175fd1cc4b3a2372b082cf2d8f616fdea254bc9a24e8 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $__internal_319393461309892924ff6e74d6d6e64287df64b63545b994e100d4ab223aed02->enter($__internal_319393461309892924ff6e74d6d6e64287df64b63545b994e100d4ab223aed02_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "security/connecte.html.twig"));
...
<div class=\"col-3 enBleu\">
    ...
    ";
        // line 24
        echo         $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->renderBlock((isset($context["formulaire"]) || array_key_exists("formulaire", $context) ? $context["formulaire"] : (function () { throw new RuntimeError('Variable "formulaire" does not exist.', 24, $this->source); })()), 'form');
        echo "
...
";
    ...
    {
        return array (  130 => 24,  126 => 22,  118 => 20,  116 => 19,  109 => 14,  102 => 13,  92 => 10,  85 => 9,  75 => 6,  68 => 5,  55 => 3,  38 => 1,);
    }
...
<div class=\"col-3 enBleu\">
    ...
    {% if app.user %}
        <div class=\"checkbox mb-3\">Heureux de vous voir, {{ app.user.username }}, <a href=\"{{ path('app_logout') }}\">Logout</a>
    {% endif %}
...
{% endblock %}
", "security/connecte.html.twig", "/var/www/renardenjoue/templates/security/connecte.html.twig");
    }
}
