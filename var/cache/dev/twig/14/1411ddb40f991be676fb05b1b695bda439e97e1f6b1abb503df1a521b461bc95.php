...
class __TwigTemplate_523e51041642b5038a177f17e40e785b1f37300e85e97a87d27b2ba68897b486 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $this->parent = $this->loadTemplate("main.html.twig", "@Twig/Exception/error404.html.twig", 1);
...
";
    ...
    <div class='row'>
        <div class='col-10' style='width:60vw; position : relative;'>
          <form method='post' action='accueil' class='float-right' style='width:60vw;'>
            <span class=\"form-error-icon badge badge-danger\" style='width:100%;'>Erreur 404</span><br>
            <img src=\"";
        // line 13
        echo twig_escape_filter($this->env, ($context["img_path"] ?? null), "html", null, true);
        echo "e404.jpg\" style='width:100%;'>
            <button class='btn-primary btn enAbsolu float-right' style='right : 1rem;' type='submit'>Retour au site</button>
          </form>
        </div>
    </div>
  </div>
...
";
    ...
    {
        return array (  116 => 26,  108 => 23,  101 => 22,  86 => 13,  79 => 8,  72 => 7,  62 => 4,  55 => 3,  38 => 1,);
    }

    public function getSourceContext()
    {
        return new Source("", "@Twig/Exception/error404.html.twig", "/var/www/renardenjoue/templates/bundles/TwigBundle/Exception/error404.html.twig");
    }
}
